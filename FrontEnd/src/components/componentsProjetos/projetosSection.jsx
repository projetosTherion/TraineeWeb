  ...
  return (
    <section className={styles.projetosContainer}>
      ...
      <div className={styles.caixaTexto}>
        ...
        <div className={styles.imagemTextoWrapper}>
          <img
              src={imagemFormatação_e_Manutenção_de_Computadores}
              alt="Ícone de ajuda"
              className={`${styles.icon} ${styles['icon-ajuste-formatacao']}`}
          /> 
          <p className={styles.texto}>
      ...
      <div className={styles.caixaTexto}>
        ...
        <div className={styles.imagemTextoWrapper}>
        <img src={imagemConsultoria_em_redes_de_computadores} alt="Ícone de ajuda" className={`${styles.icon} ${styles['icon-ajuste']}`} />
          <p className={styles.texto}>
